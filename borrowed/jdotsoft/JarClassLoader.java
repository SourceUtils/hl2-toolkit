 ...
 * <code>MyApp.main()</code> or to the
 * <code>MyAppLauncher.main()</code>
 * class (see example above). The application behavior in both cases
 * is identical. Application started with
 * <code>MyApp.main()</code>
 * uses system class loader and resources loaded from a file system.
 * Application started with
 * <code>MyAppLauncher.main()</code>
 * uses
 * <code>JarClassLoader</code> which transparently passes class
 ...
 * Application must be started with
 * <code>MyAppLauncher.main()</code> and
 * <code>JarClassLoader</code> will load
 * <code>MyApp.main()</code>
...
public class JarClassLoader extends ClassLoader {
    ...
    /**
     * The default
     * <code>ClassLoader.defineClass()</code> does not create package
     ...
     * The base class
     * <code>ClassLoader</code> keeps cache with created packages
     * for reuse.
     *
     * @param sClassName class to load.
     *
